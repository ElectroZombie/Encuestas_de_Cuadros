...
public class Database {
    ...
    public static boolean integrateDatabase(String ruta){
    ...
    public static boolean integrateDatabaseOverride(String ruta){
        Conexion CE = new Conexion(ruta);
        Conexion C = new Conexion();
        ...
        try {
            ...
            if(RS.next()){       
                ...
                Departamento D = GestionBD.getDepartamento(encuestas.elementAt(0)[2]);
                D.removeEncuestasXAno(encuestas.elementAt(0)[3]);
    ...
    public static int verifyDatabase(String ruta) {
        Conexion CE = new Conexion(ruta);
        Conexion C = new Conexion();
        ...
        try {
            ...
            stat = "select * from trabajadores_x_departamento where ano_encuesta = " + encuesta_resuelta[3] + " and id_departamento = " + encuesta_resuelta[2];
            RS = C.getConsulta().executeQuery(stat);
            if(RS.next()){
                C.desconectar();
                CE.desconectar();
